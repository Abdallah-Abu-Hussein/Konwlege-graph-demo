...
with title_col:
    st.title("Neo4J Assistant, for AI Project")
with img_col:
    st.image("https://uop.edu.jo/PublishingImages/sliderimage.jpg", width=200)
    st.image("http://www.reconow.eu/en/tmb/2185_university-of-petra-en-US.aspx?width=800&ext=jpg",width=200)
...
if user_input:
   ...
   # video_file = open('/home/mrt/Downloads/Jesse.mp4','rb')
